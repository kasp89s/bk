...
var COMMAND_MAP = {
    ...
    GOBLIN_PIDAR_QUESTIONS = [
        ...
        'Чем нельзя усилить вещь?',
        'Как называются такие предметы?',
        'Что у него в руках?',
        'Как расшифровывается аббревиатура НКД?',
        'Какое существо изображено на этой картинке?',
        'Какой валюты нет в игре?',
        'Где можно отыскать такие предметы?',
        'Где можно встретить такого персонажа?',
        'Что произойдет если смешать грибочки, сияющую пыль и траву для оформления?',
        'Кто продает еврокредиты?',
        'Сколько дней длиться месячное благо?',
        'Кто изображен на картинке?',
        'Как называется обладатель такого значка в игре?',
        'Какая Монетка Удачи есть в игре?',
    ],
    GOBLIN_PIDAR_ANSWERS = [
        ...
        'Мышка',
        'Дукат Потрошителя',
        'В Заброшенной Канализации',
        'На Вокзале',
        'Скорость передвижения увеличиться',
        'Алхимик',
        '30 дней',
        'Паук',
        'Шериф',
